...
from preprocessing.presetting import heftroman_corpus_directory, global_corpus_representation_directory, global_corpus_directory, language_model_path, vocab_lists_dicts_directory, word_translate_table_to_dict
from preprocessing.corpus import DTM


corpus_path = heftroman_corpus_directory(system)
...
for normalization in normalization_list:
    ...
    outfile_basename = "heftromane_raw_dtm_"+str(normalization)+"_"+"_use_idf_"+str(use_idf)+str(n_mfw)+"mfw.csv"
...
for normalization in normalization_list:
    ...
    new_corpus_object.generate_dtm_from_dict()
    outfile_basename = "heftromane_sraw_dtm_"+str(normalization)+"_"+"_use_idf_"+str(use_idf)+str(n_mfw)+"mfw.csv"
    dtm_outfile_path = os.path.join(outfile_dtm_path, outfile_basename)
    new_corpus_object.save_csv(dtm_outfile_path)
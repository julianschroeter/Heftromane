...
def heftroman_corpus_directory(system_name):
    if system_name == "wcph113":
        return "/mnt/data/collections/corpora/Heftromane/txt"


def heftroman_base_directory(system_name):
    if system_name == "wcph113":
        return "/mnt/data/collections/corpora/Heftromane"

...
corpus_path = os.path.join(local_temp_directory(system), "Heftromane_texte_PER-NN-V-Adj")

chunks_directory = os.path.join(local_temp_directory(system), "Heftromane_10Chunks")
...
junk_fixed_corpus_object = ChunkCorpus(corpus_path=corpus_path, outfile_directory=chunks_directory,
                                       ...
                                       fixed_chunk_length=1000, num_chunks=10,
